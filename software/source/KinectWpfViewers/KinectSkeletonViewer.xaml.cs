                ...
                switch (imageType)
                {
                    case ImageType.Color:
                        if (ColorImageFormat.Undefined != colorFormat)
                        {
                            ...
                            return new Point(
                                (int)(renderSize.Width-(renderSize.Width * colorPoint.X / colorWidth)),
                    ...
                    case ImageType.Depth:
                        if (DepthImageFormat.Undefined != depthFormat)
                        {
                            ...
                            return new Point(
                                (int)(renderSize.Width-(renderSize.Width * depthPoint.X / depthWidth)),
        ...
        private void KinectAllFramesReady(object sender, AllFramesReadyEventArgs e)
        {
            ...
            using (SkeletonFrame skeletonFrame = e.OpenSkeletonFrame())
            {
                if (skeletonFrame != null)
                {
                    ...
                    /*Seems to be where we generate the frame*/
